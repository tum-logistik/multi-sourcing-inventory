...
docker run --mount type=bind,source=/home/liul/docker/mount,target=/workspace/mount larkin/msource:latest /bin/sh -c "cd workspace/mount/multi-sourcing-inventory/; python main.py > output/run_output.txt"
