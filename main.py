...
if __name__ == '__main__':
    ...
    model_params = output_dic["model_params"]
    ...
    # eval_costs_scaled = np.array(mc_avg_costs)/output_dic['model_params']['eval_params']['sub_eval_periods']
    output_dic['adp_cost'] = np.mean(mc_avg_costs)
